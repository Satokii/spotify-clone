...
function SearchPageNavContent({ token, setToken, setTrackResults,setArtistResults, setAlbumResults,setPlaylistResults }) {
    ...
    return (
        ...
        <SearchBar token={token} setTrackResults={setTrackResults} setArtistResults={setArtistResults} setAlbumResults={setAlbumResults} setPlaylistResults={setPlaylistResults} />
