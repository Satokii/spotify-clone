...
function SearchPageNavContent({ token, setToken, setTrackResults,setArtistResults, setAlbumResults }) {
    ...
    return (
        ...
        <SearchBar token={token} setTrackResults={setTrackResults} setArtistResults={setArtistResults} setAlbumResults={setAlbumResults} />
